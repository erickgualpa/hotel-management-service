...
public class ReviewTestRepository {
  ...
  public void insertReview(
      UUID reviewIdentifier, Integer rating, String comment, UUID hotelIdentifier) {
    String query =
        """
  ...
  public ReviewResult findReview(UUID reviewIdentifier) {
    ...
    return namedParameterJdbcTemplate.queryForObject(query, queryParameters, ReviewResult.class);
  }
