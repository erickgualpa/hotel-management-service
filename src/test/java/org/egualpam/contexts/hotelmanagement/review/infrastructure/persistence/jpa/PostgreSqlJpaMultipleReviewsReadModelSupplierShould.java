...
class PostgreSqlJpaMultipleReviewsReadModelSupplierShould {

  @Mock private EntityManager entityManager;

  private ReadModelSupplier<MultipleReviewsView> testee;

  @BeforeEach
  void setUp() {
    testee = new PostgreSqlJpaMultipleReviewsReadModelSupplier(entityManager);
  }
