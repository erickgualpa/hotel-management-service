...
class FindReviewsShould {
  ...
  @Mock private ReadModelSupplier<ManyReviews> readModelSupplier;
  ...
  void findReviews() {
    ...
    when(readModelSupplier.get(any(Criteria.class))).thenReturn(manyReviews);
  ...
  void findEmptyWhenNoReviewsFound() {
    ...
    when(readModelSupplier.get(any(Criteria.class))).thenReturn(emptyReviews);
