...
public class FindReviewsQueryHandler implements QueryHandler {
  ...
  private final ReadModelSupplier<MultipleReviewsView> multipleReviewsReadModelSupplier;

  @Override
  public View handle(Query query) {
    FindReviewsQuery findReviewsQuery = (FindReviewsQuery) query;
    return multipleReviewsReadModelSupplier.get(new ReviewCriteria(findReviewsQuery.getHotelId()));
  }
}
